...
void runMCVIIncrements(Battleships* pomdp,
...
void runAOStarIncrements(Battleships* pomdp,
                         const BeliefDistribution& init_belief,
...
void runPOMCPIncrements(Battleships* pomdp, std::mt19937_64& rng,
...
int main(int argc, char* argv[]) {
  ...
  // Run MCVI
  auto mcvi_battleships = new Battleships(pomdp);
  runMCVIIncrements(mcvi_battleships, init_belief, rng, params.max_sim_depth,
  ...
  delete mcvi_battleships;

  // Compare to AO*
  auto aostar_battleships = new Battleships(pomdp);
  runAOStarIncrements(aostar_battleships, init_belief, rng,
