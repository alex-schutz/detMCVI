...
void runMCVI(Maze* pomdp, const BeliefDistribution& init_belief,
...
void runAOStar(Maze* pomdp, const BeliefDistribution& init_belief,
...
void runPOMCP(Maze* pomdp, std::mt19937_64& rng, int64_t init_belief_size,
