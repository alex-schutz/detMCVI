...
static bool CmpPair(const std::pair<std::vector<int64_t>, double>& p1,
                    const std::pair<std::vector<int64_t>, double>& p2) {
...
std::optional<double> AlphaVectorNode::GetAlpha(
    const std::vector<int64_t>& state) const {
